      ...
      <div className="mx-auto max-w-6xl space-y-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm font-bold text-slate-500">
              Semana, aniversariantes e acesso rápido aos relatórios.
            </p>
          </div>
          <div className="flex flex-wrap gap-2">
            <Link
              href="/admin?tab=vendas"
              className="inline-flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-black text-slate-700 shadow-sm transition-colors hover:bg-slate-50"
            >
              <ChevronLeft size={18} /> Voltar para vendas do dia
            </Link>
            <Link
              href="/admin?tab=relatorios"
              className="inline-flex items-center gap-2 rounded-2xl bg-slate-900 px-5 py-3 text-sm font-black text-white shadow-sm transition-colors hover:bg-slate-800"
            >
              <TrendingUp size={18} /> Abrir relatórios
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <section className="rounded-[2rem] border border-pink-200 bg-pink-50 p-5">
            ...
            <p className="mt-1 text-sm font-bold text-slate-500">
              Operacional mantido na tela principal.
            </p>
          </section>
          ...
          <section className="rounded-[2rem] border border-yellow-200 bg-yellow-50 p-5">
            ...
            <p className="mt-1 text-sm font-bold text-slate-500">
              Clientes para ação comercial do mês.
            </p>
          </section>
        </div>
              ...
              {loading ? (
                ...
                aniversariantesMes.map((cliente) => (
                  ...
                  >
                    ...
                    <p className="mt-1 text-[11px] font-bold uppercase tracking-widest text-slate-500">
                      {cliente.whatsapp || "sem número"}
                    </p>
                    <p className="mt-3 text-sm font-bold text-pink-600">
                      {cliente.data_aniversario
                        ? new Date(
                            `${String(cliente.data_aniversario).slice(0, 10)}T00:00:00`,
