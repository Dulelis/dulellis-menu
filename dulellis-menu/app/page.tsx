...
const WHATSAPP_LOJA_ACOMPANHAMENTO = "5547988400002";
const INSTAGRAM_DULELIS_URL =
  "https://www.instagram.com/dulelis_confeitaria/";
const WHATSAPP_LOJA_ACOMPANHAMENTO_LABEL = "(47) 98840-0002";
          ...
          >
            ...
            {passo === 1 ? (
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#5e4b2d] text-white p-8 rounded-[3rem] shadow-2xl">
